...
* step\_function\(\)은 인수로 받은 넘파이 배열의 원소 각각을 인수로 계단 함수 실행해, 그 결과를 다시 배열로 만들어 준다 
...
: 입력과 출력이 항상 같다는 뜻이며 입력을 그대로 출력한다. 그래서 출력층에서 항등 함수를 사용하면 입력 신호가 드래고 출력 신호가 된다 ![identityFunction](../.gitbook/assets/identityFunction.png)   
